...
export default function FormularioCadastro() {
  ...
  const mercadoLivreTipoPessoa =
    watch('mercadoLivreTipoPessoa');

  const situacaoContribuinte =
    watch('situacaoContribuinte');
  ...
  function selecionarMercadoLivreTipo(
    tipo: TipoMercadoLivre,
  ) {
    setFalha(null);
          ...
          {ehMercadoLivre && (
            <>
              <div className="secao__cabecalho">
                ...
                <h2>
                  Cadastro de cliente para
                  venda
                </h2>

                <p>
                  Escolha se o cliente será
                  cadastrado por CPF ou CNPJ.
                  O vendedor será definido
            ...
            <div className="referencias">
              <div className="referencias__cabecalho">
                <div>
                  ...
                  <p>
                    Começamos com 3. Você
                    pode adicionar até 6
                    referências.
                  </p>
                </div>
